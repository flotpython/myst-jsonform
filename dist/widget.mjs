...
var require_react_dom_production_min = __commonJS({
  "node_modules/react-dom/cjs/react-dom.production.min.js"(exports) {
    ...
    var Hd = rd(Gd);
    var Id2 = A({}, sd, { clipboardData: function(a) {
...
var require_baseConvert = __commonJS({
  "node_modules/lodash/fp/_baseConvert.js"(exports, module) {
    ...
    function baseConvert(util, name, func, options) {
      ...
      var ary = helpers.ary, assign = helpers.assign, clone = helpers.clone, curry = helpers.curry, each = helpers.forEach, isArray = helpers.isArray, isError = helpers.isError, isFunction2 = helpers.isFunction, isWeakMap = helpers.isWeakMap, keys2 = helpers.keys, rearg = helpers.rearg, toInteger = helpers.toInteger, toPath = helpers.toPath;
...
var require_baseUnset = __commonJS({
  "node_modules/lodash/_baseUnset.js"(exports, module) {
    ...
    function baseUnset(object, path) {
      ...
      return obj == null || delete obj[toKey(last2(path))];
    }
  ...
  "node_modules/lodash/_createFlow.js"(exports, module) {
    ...
    function createFlow(fromRight) {
      return flatRest(function(funcs) {
        ...
        while (++index2 < length) {
          func = funcs[index2];
          var funcName = getFuncName(func), data = funcName == "wrapper" ? getData2(func) : void 0;
...
var idSlots = /* @__PURE__ */ new Map();
var prefixStates = /* @__PURE__ */ new Map();
...
var createId = (proposedId) => {
  ...
  if (state === void 0) {
    state = { used: /* @__PURE__ */ new Set(), next: 0 };
...
var encode = (segment) => segment?.replace(/~/g, "~0").replace(/\//g, "~1");
var decode = (pointerSegment) => pointerSegment?.replace(/~1/g, "/").replace(/~0/, "~");
...
var doResolveSchema = (schema, schemaPath, ctx) => {
...
var resolvePath = (schema, schemaPath, ctx) => {
...
var resolvePathSegmentsWithCombinatorFallback = (schema, pathSegments, ctx) => {
...
var resolvePathSegments = (schema, pathSegments, ctx) => {
  if (!pathSegments || pathSegments.length === 0) {
    return schema;
  }
  if ((0, import_isEmpty.default)(schema)) {
...
var resolveSingleStep = (schema, pathSegments) => {
  if (!pathSegments || pathSegments.length === 0) {
...
(function(RuleEffect2) {
  ...
  RuleEffect2["READONLY"] = "READONLY";
  RuleEffect2["WRITABLE"] = "WRITABLE";
...
var hasReadonlyRule = (uischema) => {
  if (uischema.rule && (uischema.rule.effect === RuleEffect.READONLY || uischema.rule.effect === RuleEffect.WRITABLE)) {
    return true;
  }
  return false;
};
...
var createTranslator = (fn) => (id, defaultMessage, values) => {
...
var defaultTranslator = createTranslator((_id, defaultMessage) => defaultMessage);
...
var isInherentlyReadonly = (state, ownProps, uischema, schema, rootData, config) => {
...
var mapStateToEnumControlProps = (state, ownProps) => {
  ...
  const options = ownProps.options || props.schema.enum?.map((e) => enumToEnumOptionMapper(e, getTranslator()(state), getI18nKeyPrefix(props.schema, props.uischema, props.path))) || props.schema.const && [
...
var mapStateToLayoutProps = (state, ownProps) => {
  ...
  const readonly = isInherentlyReadonly(
    state,
    ownProps,
    uischema,
    void 0,
...
var mapStateToCellProps = (state, ownProps) => {
  ...
  const rootSchema = getSchema(state);
  let enabled;
  if (!config?.separateReadonlyFromDisabled && state.jsonforms.readonly === true) {
    enabled = false;
...
var JsonFormsStateProvider = ({ children, initState: initState2, onChange, middleware }) => {
  ...
  const [i18n, i18nDispatch] = (0, import_react.useReducer)(i18nReducer, void 0, () => i18nReducer(initState2.i18n, index$1.updateI18n(initState2.i18n?.locale, initState2.i18n?.translate, initState2.i18n?.translateError)));
  (0, import_react.useEffect)(() => {
    i18nDispatch(index$1.updateI18n(initState2.i18n?.locale, initState2.i18n?.translate, initState2.i18n?.translateError));
  }, [
    initState2.i18n?.locale,
    initState2.i18n?.translate,
    initState2.i18n?.translateError
  ]);
  ...
  const debouncedEmit = (0, import_react.useCallback)((0, import_debounce.default)((...args) => onChangeRef.current?.(...args), 10), []);
  (0, import_react.useEffect)(() => {
...
var ctxToEnumControlProps = (ctx, props) => {
  ...
  const options = (0, import_react.useMemo)(() => enumProps.options, [props.options, enumProps.schema, ctx.i18n?.translate]);
...
var ctxToEnumCellProps = (ctx, ownProps) => {
  ...
  const options = (0, import_react.useMemo)(() => cellProps.options, [ownProps.options, cellProps.schema, ctx.i18n?.translate]);
...
var ctxToOneOfEnumCellProps = (ctx, props) => {
  ...
  const options = (0, import_react.useMemo)(() => enumCellProps.options, [props.options, enumCellProps.schema, ctx.i18n?.translate]);
...
var JsonFormsDispatchRenderer = class extends import_react.default.Component {
  constructor(props) {
    super(props);
    this.state = {
      id: isControl(props.uischema) ? Id.createId(props.uischema.scope) : void 0
    };
  }
  ...
  componentDidUpdate(prevProps) {
    if (prevProps.schema !== this.props.schema) {
      Id.removeId(this.state.id);
      this.setState({
        id: isControl(this.props.uischema) ? Id.createId(this.props.uischema.scope) : void 0
      });
    }
  }
  render() {
...
var import_maxBy3 = __toESM(require_maxBy());
...
var import_reduce2 = __toESM(require_reduce());
var import_merge2 = __toESM(require_merge());
var import_range2 = __toESM(require_range());
var import_filter3 = __toESM(require_filter2());
var import_map = __toESM(require_map2());
var import_flow = __toESM(require_flow2());
var import_keys2 = __toESM(require_keys2());
var import_startCase2 = __toESM(require_startCase2());
var i18nDefaults = {
  "enum.none": "None"
};
var findStyle = (styles) => (style, ...args) => {
  const foundStyles = (0, import_filter2.default)(styles, (s) => s.name === style);
  return (0, import_reduce2.default)(foundStyles, (res, style2) => {
...
var JsonFormsStyleContext = import_react2.default.createContext(defaultContext);
var useStyleContext = () => (0, import_react2.useContext)(JsonFormsStyleContext);
var useStyles = () => {
  const { styles } = useStyleContext();
  return styles;
};
var withVanillaControlProps = (Component2) => function WithVanillaControlProps(props) {
  const ctx = useJsonForms();
  const contextStyles = useStyles();
  const controlElement = props.uischema;
  const config = ctx.config;
  const trim = config && config.trim;
  const styles = (0, import_react2.useMemo)(() => findStyle(contextStyles)("control"), [contextStyles]);
  let classNames = !(0, import_isEmpty2.default)(controlElement.scope) ? styles.concat([`${convertToValidClassName(controlElement.scope)}`]) : [""];
  if (trim) {
    classNames = classNames.concat(findStyle(contextStyles)("control.trim"));
  }
  const isValid = (0, import_isEmpty2.default)(props.errors);
  const labelClass = (0, import_react2.useMemo)(() => findStyleAsClassName(contextStyles)("control.label"), [contextStyles]);
  const descriptionClassName = (0, import_react2.useMemo)(() => findStyleAsClassName(contextStyles)("input.description"), [contextStyles]);
  const validationClassName = (0, import_react2.useMemo)(() => findStyleAsClassName(contextStyles)("control.validation"), [contextStyles]);
  const validationErrorClassName = (0, import_react2.useMemo)(() => findStyleAsClassName(contextStyles)("control.validation.error"), [contextStyles]);
  const inputClassName = ["validate"].concat(isValid ? "valid" : "invalid");
  const getStyleAsClassName = (0, import_react2.useMemo)(() => findStyleAsClassName(contextStyles), [contextStyles]);
  const getStyle = (0, import_react2.useMemo)(() => findStyle(contextStyles), [contextStyles]);
  const wrapper = classNames.join(" ");
  const input = inputClassName.join(" ");
  const classNamesProp = (0, import_react2.useMemo)(() => ({
    wrapper,
    input,
    label: labelClass,
  ...
  return import_react2.default.createElement(Component2, { ...props, getStyleAsClassName, getStyle, classNames: classNamesProp });
};
var withVanillaCellPropsForType = (type) => (Component2) => function WithVanillaCellPropsForType(props) {
  ...
  return import_react2.default.createElement(Component2, { ...props, getStyleAsClassName: findStyleAsClassName(styles), getStyle: findStyle(styles), className: inputClassName.join(" ") });
};
...
var InputControl = class extends Control {
  render() {
    ...
    const appliedUiSchemaOptions = (0, import_merge2.default)({}, config, uischema.options);
    ...
    const cell = (0, import_maxBy3.default)(cells, (r) => r.tester(uischema, schema, testerContext));
    if (cell === void 0 || cell.tester(uischema, schema, testerContext) === NOT_APPLICABLE) {
      ...
      return import_react2.default.createElement(
        ...
        import_react2.default.createElement("label", { htmlFor: id + "-input", className: classNames.label }, computeLabel(label, required, appliedUiSchemaOptions.hideRequiredAsterisk)),
        import_react2.default.createElement(DispatchCell, { uischema, schema, path, id: id + "-input", enabled }),
        import_react2.default.createElement("div", { className: divClassNames }, !isValid ? errors : showDescription ? description : null)
      );
    }
  }
};
...
var RadioGroup = ({ classNames, id, label, options, required, description, errors, data, uischema, visible, config, enabled, path, handleChange }) => {
  ...
  const radioControl = (0, import_react2.useMemo)(() => findStyleAsClassName(contextStyles)("control.radio"), [contextStyles]);
  const radioOption = (0, import_react2.useMemo)(() => findStyleAsClassName(contextStyles)("control.radio.option"), [contextStyles]);
  const radioInput = (0, import_react2.useMemo)(() => findStyleAsClassName(contextStyles)("control.radio.input"), [contextStyles]);
  const radioLabel = (0, import_react2.useMemo)(() => findStyleAsClassName(contextStyles)("control.radio.label"), [contextStyles]);
  const isValid = errors.length === 0;
  const divClassNames = [classNames.validation].concat(isValid ? classNames.description : classNames.validationError).join(" ");
  const appliedUiSchemaOptions = (0, import_merge2.default)({}, config, uischema.options);
  ...
  return import_react2.default.createElement(
    ...
    import_react2.default.createElement("label", { htmlFor: id, className: classNames.label }, computeLabel(label, required, appliedUiSchemaOptions.hideRequiredAsterisk)),
    import_react2.default.createElement("div", { className: radioControl, style: groupStyle }, options.map((option) => import_react2.default.createElement(
      "div",
      { key: option.label, className: radioOption },
      import_react2.default.createElement("input", { type: "radio", value: option.value, id: option.value, name: id, checked: data === option.value, onChange: (_) => handleChange(path, option.value), disabled: !enabled, className: radioInput }),
      import_react2.default.createElement("label", { htmlFor: option.value, className: radioLabel }, option.label)
    ))),
    import_react2.default.createElement("div", { className: divClassNames }, !isValid ? errors : showDescription ? description : null)
  );
};
var RadioGroupControl = (props) => {
  return import_react2.default.createElement(RadioGroup, { ...props });
};
...
var ArrayControl = ({ classNames, data, label, path, schema, errors, addItem, removeItems, moveUp: moveUp2, moveDown: moveDown2, uischema, uischemas, getStyleAsClassName, renderers, rootSchema, translations, enabled }) => {
  const controlElement = uischema;
  const childUiSchema = (0, import_react2.useMemo)(() => findUISchema(uischemas, schema, uischema.scope, path, void 0, uischema, rootSchema), [uischemas, schema, uischema.scope, path, uischema, rootSchema]);
  const isValid = errors.length === 0;
  ...
  return import_react2.default.createElement(
    ...
    import_react2.default.createElement(
      "header",
      null,
      import_react2.default.createElement("label", { className: labelClass }, label),
      import_react2.default.createElement(
        "button",
    ...
    import_react2.default.createElement("div", { className: divClassNames }, errors),
    import_react2.default.createElement("div", { className: classNames.children }, data ? (0, import_range2.default)(0, data.length).map((index2) => {
      const childPath = compose(path, `${index2}`);
      return import_react2.default.createElement(
        "div",
        { key: index2 },
        import_react2.default.createElement(JsonFormsDispatch, { schema, uischema: childUiSchema || uischema, path: childPath, key: childPath, renderers }),
        import_react2.default.createElement(
          "div",
          { className: childControlsClass },
          import_react2.default.createElement("button", { type: "button", className: buttonClassUp, disabled: !enabled, "aria-label": translations.upAriaLabel, onClick: () => {
            moveUp2(path, index2)();
          } }, translations.up),
          import_react2.default.createElement("button", { type: "button", className: buttonClassDown, disabled: !enabled, "aria-label": translations.downAriaLabel, onClick: () => {
            moveDown2(path, index2)();
          } }, translations.down),
          import_react2.default.createElement("button", { type: "button", className: buttonClassDelete, disabled: !enabled, "aria-label": translations.removeAriaLabel, onClick: () => {
    ...
    }) : import_react2.default.createElement("p", null, translations.noDataMessage))
  );
};
var ArrayControlRenderer = ({ schema, uischema, data, path, rootSchema, uischemas, addItem, getStyle, getStyleAsClassName, removeItems, moveUp: moveUp2, moveDown: moveDown2, id, visible, enabled, errors, translations, arraySchema }) => {
  const controlElement = uischema;
  const labelDescription2 = Helpers.createLabelDescriptionFrom(controlElement, schema);
  const label = labelDescription2.show ? labelDescription2.text : "";
  ...
  return import_react2.default.createElement(ArrayControl, { classNames, data, label, path, schema, arraySchema, errors, addItem, removeItems, moveUp: moveUp2, moveDown: moveDown2, uischema, uischemas, getStyleAsClassName, rootSchema, id, visible, enabled, getStyle, translations });
};
...
var isCategorization2 = (category) => category.type === "Categorization";
var categorizationTester = rankWith(1, and(uiTypeIs("Categorization"), (uischema) => {
  const hasCategory2 = (element) => {
    if ((0, import_isEmpty2.default)(element.elements)) {
      return false;
    }
    return element.elements.map((elem) => isCategorization2(elem) ? hasCategory2(elem) : elem.type === "Category").reduce((prev, curr) => prev && curr, true);
  };
...
var CategorizationRenderer = ({ data, uischema, schema, path, selected, t, visible, getStyleAsClassName, onChange, ajv: ajv2, config }) => {
  ...
  const [previousCategorization, setPreviousCategorization] = (0, import_react2.useState)(uischema);
  const [activeCategory, setActiveCategory] = (0, import_react2.useState)(selected ?? 0);
  ...
  return import_react2.default.createElement(
    ...
    import_react2.default.createElement(
      ...
      import_react2.default.createElement(SingleCategory, { category: elements[safeCategory], schema, path, key: safeCategory })
    )
  );
};
...
var LabelRenderer = ({ text, visible, getStyleAsClassName }) => {
  const classNames = getStyleAsClassName("label-control");
  const isHidden = !visible;
  return import_react2.default.createElement("label", { hidden: isHidden, className: classNames }, text);
};
...
var { or: or2, isObjectArrayControl: isObjectArrayControl2, isPrimitiveArrayControl: isPrimitiveArrayControl2, rankWith: rankWith2 } = index;
var tableArrayControlTester = rankWith2(3, or2(isObjectArrayControl2, isPrimitiveArrayControl2));
var TableArrayControl = class extends import_react2.default.Component {
  constructor() {
    super(...arguments);
  ...
  render() {
    ...
    const createControlElement2 = (key) => ({
      type: "Control",
      label: false,
      scope: schema.type === "object" ? `#/properties/${key}` : "#"
    });
    const isValid = errors.length === 0;
    const divClassNames = [validationClass].concat(isValid ? "" : getStyleAsClassName("array.table.validation.error")).join(" ");
    return import_react2.default.createElement(
      "div",
      ...
      import_react2.default.createElement(
        ...
        null,
        import_react2.default.createElement("label", { className: labelClass }, label),
        import_react2.default.createElement("button", { type: "button", disabled: !enabled, className: buttonClass, onClick: addItem(path, createDefaultValue(schema, rootSchema)) }, translations.addTooltip)
      ),
      import_react2.default.createElement("div", { className: divClassNames }, !isValid ? errors : ""),
      import_react2.default.createElement(
        "table",
        ...
        import_react2.default.createElement(
          ...
          import_react2.default.createElement(
            "tr",
            null,
            schema.properties ? (0, import_flow.default)(import_keys2.default, (0, import_filter3.default)((prop) => schema.properties[prop].type !== "array"), (0, import_map.default)((prop) => import_react2.default.createElement("th", { key: prop }, schema.properties[prop].title ?? (0, import_startCase2.default)(prop))))(schema.properties) : import_react2.default.createElement("th", null, "Items"),
            import_react2.default.createElement("th", null, "Valid"),
            import_react2.default.createElement("th", null, "\xA0")
          )
        ),
        import_react2.default.createElement("tbody", null, !data || !Array.isArray(data) || data.length === 0 ? import_react2.default.createElement(
          "tr",
          null,
          import_react2.default.createElement("td", null, translations.noDataMessage)
        ) : data.map((_child, index2) => {
          const childPath = Paths.compose(path, `${index2}`);
          const errorsPerEntry = (0, import_filter2.default)(childErrors, (error) => {
          ...
          return import_react2.default.createElement(
            "tr",
            { key: childPath },
            schema.properties ? (0, import_flow.default)(import_keys2.default, (0, import_filter3.default)((prop) => schema.properties[prop].type !== "array"), (0, import_map.default)((prop) => {
              const childPropPath = Paths.compose(childPath, prop.toString());
              return import_react2.default.createElement(
                "td",
                { key: childPropPath },
                import_react2.default.createElement(DispatchCell, { schema: Resolve.schema(schema, `#/properties/${encode(prop)}`, rootSchema), uischema: createControlElement2(encode(prop)), path: childPath + "." + prop })
              );
            }))(schema.properties) : import_react2.default.createElement(
              "td",
              { key: Paths.compose(childPath, index2.toString()) },
              import_react2.default.createElement(DispatchCell, { schema, uischema: createControlElement2(), path: childPath })
            ),
            import_react2.default.createElement("td", null, errorsPerEntry ? import_react2.default.createElement("span", { className: errorClassNames }, (0, import_join.default)(errorsPerEntry.map((e) => e.message), " and ")) : import_react2.default.createElement("span", { className: errorClassNames }, "OK")),
            import_react2.default.createElement(
              "td",
              null,
              import_react2.default.createElement("button", { type: "button", disabled: !enabled, "aria-label": translations.removeAriaLabel, onClick: () => {
...
var BooleanCell = (props) => {
  ...
  return import_react2.default.createElement("input", { type: "checkbox", checked: !!data, onChange: (ev) => handleChange(path, ev.target.checked), className, id, disabled: !enabled, autoFocus: uischema.options && uischema.options.focus });
};
...
var DateCell = (props) => {
  const { data, className, id, enabled, uischema, path, handleChange } = props;
  return import_react2.default.createElement("input", { type: "date", value: data || "", onChange: (ev) => handleChange(path, ev.target.value), className, id, disabled: !enabled, autoFocus: uischema.options && uischema.options.focus });
};
...
var DateTimeCell = (props) => {
  ...
  return import_react2.default.createElement("input", { type: "datetime-local", value: (data || "").substr(0, 16), onChange: (ev) => handleChange(path, toISOString(ev.target.value)), className, id, disabled: !enabled, autoFocus: uischema.options && uischema.options.focus });
};
...
var EnumCell = (props) => {
  ...
  const noneOptionLabel = (0, import_react2.useMemo)(() => t("enum.none", i18nDefaults["enum.none"], { schema, uischema, path }), [t, schema, uischema, path]);
  return import_react2.default.createElement("select", { className, id, disabled: !enabled, autoFocus: uischema.options && uischema.options.focus, value: data || "", onChange: (ev) => handleChange(path, ev.target.selectedIndex === 0 ? void 0 : ev.target.value) }, [
    import_react2.default.createElement("option", { value: "", key: "jsonforms.enum.none" }, noneOptionLabel)
  ].concat(options.map((optionValue) => import_react2.default.createElement("option", { value: optionValue.value, label: optionValue.label, key: optionValue.value }))));
};
...
var IntegerCell = (props) => {
  const { data, className, id, enabled, uischema, path, handleChange } = props;
  return import_react2.default.createElement("input", { type: "number", step: "1", value: data ?? "", onChange: (ev) => handleChange(path, toNumber$1(ev.target.value)), className, id, disabled: !enabled, autoFocus: uischema.options && uischema.options.focus });
};
...
var NumberCell = (props) => {
  const { data, className, id, enabled, uischema, path, handleChange } = props;
  return import_react2.default.createElement("input", { type: "number", step: "0.1", value: data ?? "", onChange: (ev) => handleChange(path, toNumber(ev.target.value)), className, id, disabled: !enabled, autoFocus: uischema.options && uischema.options.focus });
};
...
var NumberFormatCell = (props) => {
  ...
  return import_react2.default.createElement("input", { type: "text", value: formattedNumber, onChange, className, id, disabled: !enabled, autoFocus: uischema.options && uischema.options.focus, maxLength: uischema.options && uischema.options.restrict ? maxLength : void 0, size: uischema.options && uischema.options.trim ? maxLength : void 0 });
};
...
var OneOfEnumCell = (props) => {
  const { data, className, id, enabled, schema, uischema, path, handleChange, options, t } = props;
  const noneOptionLabel = (0, import_react2.useMemo)(() => t("enum.none", i18nDefaults["enum.none"], { schema, uischema, path }), [t, schema, uischema, path]);
  const noneOption = import_react2.default.createElement("option", { value: "", key: "jsonforms.enum.none" }, noneOptionLabel);
  return import_react2.default.createElement("select", { className, id, disabled: !enabled, autoFocus: uischema.options && uischema.options.focus, value: data || "", onChange: (ev) => handleChange(path, ev.target.selectedIndex === 0 ? void 0 : ev.target.value) }, (uischema.options?.hideEmptyOption === true ? [] : [noneOption]).concat(options.map((optionValue) => import_react2.default.createElement("option", { value: optionValue.value, label: optionValue.label, key: optionValue.value }))));
};
...
var SliderCell = (props) => {
  ...
  return import_react2.default.createElement(
    "div",
    { style: { display: "flex" } },
    import_react2.default.createElement("input", { type: "range", max: schema.maximum, min: schema.minimum, value: data || schema.default, onChange: (ev) => handleChange(path, Number(ev.target.value)), className, id, disabled: !enabled, autoFocus: uischema.options && uischema.options.focus, style: { flex: "1" } }),
    import_react2.default.createElement("label", { style: { marginLeft: "0.5em" } }, data || schema.default)
  );
};
...
var TextAreaCell = (props) => {
  ...
  const appliedUiSchemaOptions = (0, import_merge2.default)({}, config, uischema.options);
  return import_react2.default.createElement("textarea", { value: data || "", onChange: (ev) => handleChange(path, ev.target.value === "" ? void 0 : ev.target.value), className, id, disabled: !enabled, autoFocus: appliedUiSchemaOptions.focus, placeholder: appliedUiSchemaOptions.placeholder });
};
...
var TimeCell = (props) => {
  const { data, className, id, enabled, uischema, path, handleChange } = props;
  return import_react2.default.createElement("input", { type: "time", value: data || "", onChange: (ev) => handleChange(path, appendSecondsIfNecessary(ev.target.value)), className, id, disabled: !enabled, autoFocus: uischema.options && uischema.options.focus });
};
...
var renderChildren = (layout, schema, className, path, enabled) => {
  if ((0, import_isEmpty2.default)(layout.elements)) {
    return [];
  }
  ...
  return layout.elements.map((child, index2) => {
    return import_react2.default.createElement(
      ...
      import_react2.default.createElement(JsonFormsDispatch, { renderers, cells, uischema: child, schema, path, enabled })
    );
  });
};
...
var GroupLayoutRenderer = (props) => {
  ...
  return import_react2.default.createElement(GroupLayoutRendererComponent, { ...otherProps });
};
var GroupLayoutRendererComponent = import_react2.default.memo(function GroupLayoutRendererComponent2({ schema, uischema, path, enabled, visible, label, getStyle, getStyleAsClassName }) {
  ...
  return import_react2.default.createElement(
    ...
    !(0, import_isEmpty2.default)(label) ? import_react2.default.createElement("legend", { className: getStyleAsClassName("group.label") }, label) : "",
...
var JsonFormsLayout = ({ className, children, visible }) => {
  return import_react2.default.createElement("div", { className, hidden: visible === void 0 || visible === null ? false : !visible }, children);
};
var horizontalLayoutTester = rankWith(1, uiTypeIs("HorizontalLayout"));
var HorizontalLayoutRenderer = (props) => {
  const { data: _data, ...otherProps } = props;
  return import_react2.default.createElement(HorizontalLayoutRendererComponent, { ...otherProps });
};
var HorizontalLayoutRendererComponent = import_react2.default.memo(function HorizontalLayoutRendererComponent2({ schema, uischema, getStyle, getStyleAsClassName, enabled, visible, path }) {
  ...
  return import_react2.default.createElement(JsonFormsLayout, { className: layoutClassName, visible, enabled, path, uischema, schema, getStyle, getStyleAsClassName }, renderChildren(horizontalLayout, schema, childClassNames, path, enabled));
});
...
var VerticalLayoutRenderer = (props) => {
  const { data: _data, ...otherProps } = props;
  return import_react2.default.createElement(VerticalLayoutRendererComponent, { ...otherProps });
};
var VerticalLayoutRendererComponent = import_react2.default.memo(function VerticalLayoutRendererComponent2({ schema, uischema, path, visible, enabled, getStyle, getStyleAsClassName }) {
  ...
  return import_react2.default.createElement(JsonFormsLayout, { className: layoutClassName, uischema, schema, visible, enabled, path, getStyle, getStyleAsClassName }, renderChildren(verticalLayout, schema, childClassNames, path, enabled));
});
